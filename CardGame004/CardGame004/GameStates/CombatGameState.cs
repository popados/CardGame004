...
{
    public class CombatGameState : State
    {
        private List<GameObject> gameObjects;

        public CombatGameState(Game1 game, GraphicsDevice graphicsDevice, ContentManager content) : base(game, graphicsDevice, content)
        {
